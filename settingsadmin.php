...
<?php echo "Hi,"."  $_SESSION[login_user]"; ?>
  ...
  <a href="addotherexpenseuser.php" style="font-size: 15px"><i class="fas fa-file-invoice-dollar"></i>Add other expenses to the user</a>
    <hr style="background-color: #F5F5F5;">
  <a href="admintransaction.php" style="font-size: 15px"><i class="fas fa-file-invoice-dollar"></i>Pay residents fare</a>
    <hr style="background-color: #F5F5F5;">
      <a href="admincontact.php" style="font-size: 15px"><i class="fas fa-file-invoice-dollar"></i>Incoming Messages</a>
    <hr style="background-color: #F5F5F5;">      
    <a href="settingsadmin.php" style="font-size: 15px"><i class="fas fa-file-invoice-dollar"></i>Settings</a>
    <hr style="background-color: #F5F5F5;">
</div>
