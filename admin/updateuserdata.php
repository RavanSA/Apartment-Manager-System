...
$username = $email = $phonenumber = $blocktype = $apartnumber = $ifmoved = $moveddate = "";
$usernErr = $emailErr = $phonenErr = $blcktErr = $aptnErr = $ifmovErr = $movdatErr = "";
...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $moveddate = trim($_POST["moveddate"]);
    
        $sql = "UPDATE user SET username=?, email=?, phonenumber=?, blocktype=?, apartmentnumber=?, ifmoved=?, moveddate=? WHERE id=?";
        if($stmt = mysqli_prepare($dbconnection, $sql)){

            mysqli_stmt_bind_param($stmt, "sssssssi", $param_name, $param_email, $param_phone, $param_blck, $param_aptn, $param_move, $param_moveddate, $param_id);
